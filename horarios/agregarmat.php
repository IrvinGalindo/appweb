...
<body>
  <?php include("mod_mat.php");?>
  <?php include("add_mat.php");?>
  <?php include("modal_eliminar_mat.php");?>
  ...
  <?php include("mod_inst.php");?>
    ...
    <div class="container">
        <div class="row"> <!--aqui va estar un titulo-->
                <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        <center><h1>CONTROL DE MATERIAS</h1></center>
                    </div>
      ...
      <div class="row"> <!--aqui van a estar los botones de agregar, eliminar  actualizar-->
                <div class="col-md-4"></div> 
                    <div class="col-md-4">
                      <form method="POST" action="agregarmat.php" ><center>
           <input type="submit" value="Ver Lista de Materias" class="btn btn-primary" name="btn1">
          <button type='button' class='btn btn-success' data-toggle='modal' data-target='#addDataMat'>Agregar materia</button></center>
           </form>
           <div class="row">
...

    {
      ...
      include("conexion.php");
        ...
        $resultados = mysqli_query($conexion,"SELECT * FROM materia");
        ...
        while ($consulta = mysqli_fetch_array($resultados))
        {
         ...
         echo "<tr>"; 
                  ...
                  echo "<td><center> <button type='button' class='btn btn-success' data-toggle='modal' data-target='#dataUpdateMat' data-cve=".$consulta['cveMateria']." data-nombre= ".$consulta['nombre']."><i class='glyphicon glyphicon-edit'></i>Modificar</button></center></td>";
                echo " <td><center><button type='button'class='btn btn-danger'  data-toggle='modal' data-target='#dataDelete' data-id=".$consulta['cveMateria']."  ><i class='glyphicon glyphicon-trash'></i> Eliminar</button></center></td>";
                echo "</tr>";
           }
